export default function Header({ title, points, unreadCount = 0, onMenu, onBell }) {
  return (
    <header className="sticky top-0 z-30 flex h-12 items-center gap-2 bg-[#d7b54a] px-2 text-white sm:gap-3 sm:px-5">
      ...
      <h1 className="min-w-0 flex-1 truncate text-center text-[15px] font-normal sm:text-[17px]">{title}</h1>

      <span className="shrink-0 whitespace-nowrap text-[12px] sm:text-[15px]">Points :{points}</span>
